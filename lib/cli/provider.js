...
exports.balancesSandshrewProviderCall = exports.multiCallSandshrewProviderCall = exports.ordProviderCall = exports.alkanesProvider = void 0;
...
*/
exports.balancesSandshrewProviderCall = new commander_1.Command('sandShrewBalance')
    .description('Send multiple calls to sandshrew provider')
    .requiredOption('-p, --provider <provider>', 'Network provider type (regtest, bitcoin)')
    .requiredOption('-a, --address <address>', 'calls in this format: {method: string, params: string[]}')
    .action(async (options) => {
    try {
