...
const btcSend = new commander_1.Command('send')
  ...
  */
    ...
    const { accountSpendableTotalUtxos, accountSpendableTotalBalance } = await __1.utxo.accountUtxos({ account, provider });
...
const collectibleSend = new commander_1.Command('send')
  ...
  */
    ...
    const gatheredUtxos = await __1.utxo.accountUtxos({ account, provider });
