...
const alkaneCommand = new commander_1.Command('alkane')
    ...
    .addCommand(alkane_1.alkaneMultiSend)
    .addCommand(alkane_1.alkaneCreatePool)
    .addCommand(alkane_1.alkaneSpendCommit)
    ...
    .addCommand(alkane_1.initMerkleRoot)
    .addCommand(alkane_1.merkleClaim)
    .addCommand(alkane_1.subfrostWrapAddress)
    .addCommand(alkane_1.alkaneWrapBtc)
    .addCommand(alkane_1.alkaneUnwrapBtc);
const providerCommand = new commander_1.Command('provider')
    ...
    .addCommand(provider_1.balancesSandshrewProviderCall);
