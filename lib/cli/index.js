...
const multiCallSandshrewProviderCall = new commander_1.Command('sandShrewMulticall')
    ...
    /* @dev example call
      oyl provider sandShrewMulticall -c '[{"method":"esplora_tx","params":["688f5c239e4e114af461dc1331d02ad5702e795daf2dcf397815e0b05cd23dbc"]},{"method":"esplora_fee-estimates", "params":['']}]' -p bitcoin
    */
    .action(async (options) => {
    let isJson = [];
    try {
