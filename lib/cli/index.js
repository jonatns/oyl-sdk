...
const addressCommand = Object.values(address_1.ADDRESS_COMMANDS).reduce((r, command) => r.addCommand(command), new commander_1.Command("address").description("Address utils"));
