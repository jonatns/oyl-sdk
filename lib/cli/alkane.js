...
exports.alkaneSplit = exports.alkaneSend = exports.alkaneExecute = exports.alkaneTokenDeploy = exports.alkaneContractDeploy = exports.alkanesTrace = void 0;
...
exports.alkaneSend = new commander_1.Command('send')
    ...
    const calldata = options.calldata.map((item) => BigInt(item));
    console.log(await (0, factory_1.createNewPool)(calldata, { block: "2", tx: "2" }, BigInt(50000), { block: "2", tx: "3" }, BigInt(50000), {
        utxos: accountSpendableTotalUtxos,
        totalAmount: accountSpendableTotalBalance,
...
exports.alkaneSplit = new commander_1.Command('split')
    ...
    console.log(await (0, factory_1.splitAlkaneUtxos)({ block: options.block1, tx: options.txNum1 }, BigInt(options.amount1), { block: options.block2, tx: options.txNum2 }, BigInt(options.amount2), {
        utxos: accountSpendableTotalUtxos,
        totalAmount: accountSpendableTotalBalance,
    }, wallet.feeRate, wallet.account, wallet.signer, wallet.provider));
});
