...
exports.alkaneSpendCommit = new AlkanesCommand('spend-commit')
    ...
    if (options.method === 'reveal') {
        ...
        const vout = commitTx.vout.find((vout) => vout.scriptpubkey_address === wallet.account.taproot.address);
        if (!vout) {
...
exports.initMerkleRoot = new AlkanesCommand('init-merkle-root')
    ...
    const rootFirstHalf = (0, utils_1.readU128LE)(root.slice(0, 16));
    const rootSecondHalf = (0, utils_1.readU128LE)(root.slice(16, 32));
