...
exports.alkaneSend = exports.alkaneSplit = exports.alkaneBurn = exports.alkaneExecute = exports.alkaneTokenDeploy = exports.alkaneContractDeploy = exports.alkanesTrace = void 0;
...
exports.alkanesTrace = new commander_1.Command('trace')
    ...
    console.log(await provider.alkanes.trace({
        vout,
        txid,
    }));
});
...
/* @dev example call
  ...
  Burns an alkane token amount (example is burning token with Alkane ID [2, 1])
*/
...
exports.alkaneSplit = new commander_1.Command('split')
    .requiredOption('-tokens, --tokens <tokens>', 'tokens to split', (value, previous) => {
    const items = value.split(',');
    return previous ? previous.concat(items) : items;
}, [])
    .option('-m, --mnemonic <mnemonic>', '(optional) Mnemonic used for signing transactions (default = TEST_WALLET)')
    ...
    console.log('alkaneTokensToSplit', alkaneTokensToSplit);
...
exports.alkaneSend = new commander_1.Command('send')
    ...
    const calldata = options.calldata.map((item) => BigInt(item));
    console.log(await (0, factory_1.createNewPool)(calldata, { block: "2", tx: "4" }, BigInt(50000), { block: "2", tx: "5" }, BigInt(50000), {
        utxos: accountSpendableTotalUtxos,
        totalAmount: accountSpendableTotalBalance,
    }, wallet.feeRate, wallet.account, wallet.signer, wallet.provider));
});
