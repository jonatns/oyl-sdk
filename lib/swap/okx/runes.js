...
exports.simulateRunesBuy = exports.buildOkxRunesPsbt = void 0;
...
function simulateRunesBuy(sellerAddress, receieveAddress, utxos, orderPrice) {
    const txInputs = [];
    const txOutputs = [];
...
exports.simulateRunesBuy = simulateRunesBuy;
