...
async function okxSwap({ address, offer, receiveAddress, feeRate, pubKey, assetType, provider, utxos = [], signer }) {
    ...
    if (psbtForDummyUtxos != null) {
        ...
        console.log("original utxos", utxos);
        ...
        console.log(" locally updated utxos", utxos);
        console.log("fetched updated utxos", (await (0, utxo_1.addressSpendableUtxos)({ address, provider })).utxos);
        return;
    }
    const unsignedBid = {
