...
exports.processMagisatOffer = void 0;
const interface_1 = require("../../shared/interface");
const utils_1 = require("../../shared/utils");
const helpers_1 = require("../helpers");
const types_1 = require("../types");
async function processMagisatOffer({ address, offer, receiveAddress, feeRate, pubKey, assetType, provider, utxos, signer }) {
    let dummyTxId = null;
...
exports.processMagisatOffer = processMagisatOffer;
