...
exports.processOrdinalsWalletOffer = exports.submitPsbt = exports.getSellerPsbt = void 0;
...
async function processOrdinalsWalletOffer({ address, offer, receiveAddress, feeRate, pubKey, assetType, provider, utxos, signer, }) {
    let dummyTxId = null;
...
exports.processOrdinalsWalletOffer = processOrdinalsWalletOffer;
