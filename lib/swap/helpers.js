...
exports.buildPsbtWithFee = exports.estimatePsbtFee = exports.psbtTxAddressTypes = exports.dummyUtxosPsbt = exports.prepareAddressForDummyUtxos = exports.sanitizeFeeRate = exports.selectSpendAddress = exports.calculateAmountGathered = exports.canAddressAffordBid = exports.getBidCostEstimate = exports.addInputConditionally = exports.getAllUTXOsWorthASpecificValue = exports.isExcludedUtxo = exports.getUTXOsToCoverAmount = exports.DUMMY_UTXO_SATS = exports.ESTIMATE_TX_SIZE = exports.CONFIRMED_UTXO_ENFORCED_MARKETPLACES = exports.maxTxSizeForOffers = void 0;
...
exports.CONFIRMED_UTXO_ENFORCED_MARKETPLACES = [types_1.Marketplaces.UNISAT];
...
async function selectSpendAddress({ offers, provider, feeRate, account }) {
    ...
    for (let i = 0; i < account.spendStrategy.addressOrder.length; i++) {
        if (account.spendStrategy.addressOrder[i] === 'taproot' ||
            ...
            let pubkey = account[this.account.spendStrategy.addressOrder[i]].pubkey;
...
async function prepareAddressForDummyUtxos({ address, provider, pubKey, feeRate, addressType, utxos = [] }) {
    try {
        if (utxos.length < 1) {
            utxos = (await (0, utxo_1.addressSpendableUtxos)({ address, provider })).utxos;
        }
