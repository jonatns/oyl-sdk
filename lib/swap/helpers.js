...
exports.DUMMY_UTXO_SATS = exports.ESTIMATE_TX_SIZE = exports.DUMMY_UTXO_ENFORCED_MARKETPLACES = exports.CONFIRMED_UTXO_ENFORCED_MARKETPLACES = exports.maxTxSizeForOffers = void 0;
 ...
 *  */
async function canAddressAffordBid({ estimatedCost, offers, utxos }) {
...
async function selectSpendAddress({ offers, provider, feeRate, account, utxos }) {
