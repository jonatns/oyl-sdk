...
exports.buildPsbtWithFee = exports.estimatePsbtFee = exports.psbtTxAddressTypes = exports.updateUtxos = exports.dummyUtxosPsbt = exports.prepareAddressForDummyUtxos = exports.sanitizeFeeRate = exports.selectSpendAddress = exports.calculateAmountGathered = exports.canAddressAffordBid = exports.getBidCostEstimate = exports.addInputConditionally = exports.getAllUTXOsWorthASpecificValue = exports.isExcludedUtxo = exports.getUTXOsToCoverAmount = exports.DUMMY_UTXO_SATS = exports.ESTIMATE_TX_SIZE = exports.DUMMY_UTXO_ENFORCED_MARKETPLACES = exports.CONFIRMED_UTXO_ENFORCED_MARKETPLACES = exports.maxTxSizeForOffers = void 0;
...
exports.DUMMY_UTXO_ENFORCED_MARKETPLACES = [types_1.Marketplaces.OKX, types_1.Marketplaces.ORDINALS_WALLET];
...
function updateUtxos({ originalUtxos, txId, inputTemplate, swapTx = false, outputTemplate }) {
