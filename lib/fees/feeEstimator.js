...
class FeeEstimator {
    ...
    calculateScriptWitnessSize() {
        var _a;
        return this.analyzePSBTComponents().inputTypes.includes("taproot") && ((_a = this.witness) === null || _a === void 0 ? void 0 : _a.length)
    ...
    getBaseSize() {
        ...
        const witnessSize = inputVBytes.witness + (((_a = this.witness) === null || _a === void 0 ? void 0 : _a.length) ? this.calculateScriptWitnessSize() : 0);
        return {
            baseSize: inputVBytes.input + inputVBytes.txHeader + outputVBytes,
            witnessSize: ((_b = this.witness) === null || _b === void 0 ? void 0 : _b.length) ? witnessSize : witnessSize > 0 ? witnessHeaderSize + witnessSize : 0
        };
    }
