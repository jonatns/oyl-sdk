...
const createCommitPsbt = async ({ payload, utxos, account, protostone, provider, feeRate, frontendFee, feeAddress, }) => {
...
const createRevealPsbt = async ({ payload, utxos, account, protostone, provider, feeRate, commitTxId, commitPsbtBase64, script, }) => {
