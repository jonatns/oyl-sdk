...
exports.tokenDeployment = exports.contractDeployment = exports.createTransactReveal = exports.execute = exports.executeReveal = exports.deployReveal = exports.deployCommit = exports.send = exports.actualExecuteFee = exports.actualTransactRevealFee = exports.actualDeployRevealFee = exports.actualDeployCommitFee = exports.actualSendFee = exports.findAlkaneUtxos = exports.createDeployReveal = exports.createDeployCommit = exports.createExecutePsbt = exports.createSendPsbt = void 0;
...
const tokenDeployment = async ({ payload, gatheredUtxos, account, calldata, provider, feeRate, signer, }) => {
    ...
    await (0, utils_1.timeout)(3000);
    const reveal = await (0, exports.executeReveal)({
        calldata,
        script,
        commitTxId: txId,
        account,
