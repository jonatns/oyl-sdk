...
const createExecutePsbt = async ({ alkaneUtxos, gatheredUtxos, account, protostone, protostone1, provider, feeRate, fee = 0, }) => {
    try {
...
const actualExecuteFee = async ({ gatheredUtxos, account, protostone, protostone1, provider, feeRate, signer, alkaneUtxos, }) => {
    if (!feeRate) {
        feeRate = (await provider.esplora.getFeeEstimates())['1'];
    }
...
const execute = async ({ alkaneUtxos, gatheredUtxos, account, protostone, protostone1, provider, feeRate, signer, }) => {
