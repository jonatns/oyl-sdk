...
exports.deployReveal = exports.deployCommit = exports.actualDeployRevealFee = exports.actualDeployCommitFee = exports.createDeployReveal = exports.createDeployCommit = exports.createMintPsbt = void 0;
...
const createDeployCommit = async ({ gatheredUtxos, tweakedTaprootKeyPair, account, provider, feeRate, fee, }) => {
    try {
        ...
        gatheredUtxos = (0, utils_1.findXAmountOfSats)(originalGatheredUtxos.utxos, 3000 + Number(utils_1.inscriptionSats));
        if (!fee && gatheredUtxos.utxos.length > 1) {
            const txSize = (0, btc_1.minimumFee)({
                taprootInputCount: gatheredUtxos.utxos.length,
                nonTaprootInputCount: 0,
        ...
        const changeAmount = gatheredUtxos.totalAmount - (finalFee + 30000 + utils_1.inscriptionSats);
        psbt.addOutput({
            address: account[account.spendStrategy.changeAddress].address,
            value: changeAmount,
        });
