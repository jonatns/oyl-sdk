...
exports.toTxId = exports.createTransactReveal = exports.execute = exports.executePsbt = exports.actualExecuteFee = exports.actualTransactRevealFee = exports.findAlkaneUtxos = exports.deployReveal = exports.createDeployRevealPsbt = exports.deployCommit = exports.createDeployCommitPsbt = exports.createExecutePsbt = exports.encodeProtostone = void 0;
...
const findAlkaneUtxos = async ({ gatheredUtxos, greatestToLeast, alkaneId, targetNumberOfAlkanes, }) => {
