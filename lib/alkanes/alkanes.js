...
exports.transactReveal = exports.createTransactReveal = exports.execute = exports.executeReveal = exports.deployReveal = exports.deployCommit = exports.send = exports.actualExecuteFee = exports.actualTransactRevealFee = exports.actualDeployRevealFee = exports.actualDeployCommitFee = exports.actualSendFee = exports.findAlkaneUtxos = exports.createDeployReveal = exports.createDeployCommit = exports.createExecutePsbt = exports.createSendPsbt = void 0;
...
const actualTransactRevealFee = async ({ calldata, tweakedTaprootKeyPair, commitTxId, receiverAddress, script, provider, feeRate, }) => {
    if (!feeRate) {
        feeRate = (await provider.esplora.getFeeEstimates())['1'];
    }
    const { psbtHex } = await (0, exports.createTransactReveal)({
        calldata,
        commitTxId,
        receiverAddress,
        script,
    ...
    const vsize = (await provider.sandshrew.bitcoindRpc.testMemPoolAccept([psbtHex]))[0].vsize;
    const correctFee = vsize * feeRate;
    const { psbtHex: finalPsbtHex } = await (0, exports.createTransactReveal)({
        calldata,
        commitTxId,
        receiverAddress,
        script,
...
const transactReveal = async ({ payload, gatheredUtxos, account, calldata, provider, feeRate, signer, }) => {
    const { script, txId } = await (0, exports.deployCommit)({
        payload,
        gatheredUtxos,
        account,
        provider,
    ...
    const revealResult = await (0, exports.executeReveal)({
        calldata,
        script,
        commitTxId: txId,
        account,
...
exports.transactReveal = transactReveal;
