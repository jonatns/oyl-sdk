...
exports.p2tr_ord_reveal = exports.toAlkaneId = exports.toTxId = exports.createTransactReveal = exports.execute = exports.executePsbt = exports.actualExecuteFee = exports.actualTransactRevealFee = exports.deployReveal = exports.createDeployRevealPsbt = exports.deployCommit = exports.createDeployCommitPsbt = exports.addInputForUtxo = exports.createExecutePsbt = exports.encodeProtostone = void 0;
...
const actualTransactRevealFee = async ({ protostone, tweakedPublicKey, commitTxId, receiverAddress, script, provider, feeRate, account, }) => {
    if (!feeRate) {
        feeRate = (await provider.esplora.getFeeEstimates())['1'];
    }
...
const createTransactReveal = async ({ alkanesUtxos, protostone, receiverAddress, script, feeRate, tweakedPublicKey, provider, fee = 0, commitTxId, account, }) => {
    try {
        if (!feeRate) {
            feeRate = (await provider.esplora.getFeeEstimates())['1'];
        }
