...
const executeFallbackToWitnessProxy = async ({ alkanesUtxos, utxos, account, calldata, provider, feeRate, signer, frontendFee, feeAddress, witnessProxy, frbtcWrapAmount, frbtcUnwrapAmount, frbtcUtxoForUnwrap, addDieselMint, }) => {
    let frbtcWrapPsbt;
    if (frbtcWrapAmount) {
...
const execute = async ({ alkanesUtxos, utxos, account, protostone, provider, feeRate, signer, frontendFee, feeAddress, frbtcWrapPsbt, frbtcUnwrapAmount, frbtcUtxoForUnwrap, }) => {
    const { fee } = await (0, exports.actualExecuteFee)({
        alkanesUtxos,
        frontendFee,
        feeAddress,
