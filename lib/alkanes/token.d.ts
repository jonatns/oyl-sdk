...
export declare const createCommitPsbt: ({ payload, utxos, account, protostone, provider, feeRate, frontendFee, feeAddress, }: {
    payload: AlkanesPayload;
    utxos: FormattedUtxo[];
    account: Account;
    protostone: Buffer;
...
export declare const createRevealPsbt: ({ payload, utxos, account, protostone, provider, feeRate, commitTxId, commitPsbtBase64, script, }: {
    payload: AlkanesPayload;
    utxos: FormattedUtxo[];
    account: Account;
    protostone: Buffer;
