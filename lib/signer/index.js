...
class Signer {
    ...
    SignAllTaprootInputs({ rawPsbt, finalize, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < unSignedPsbt.inputCount; i++) {
                const matchingPubKey = unSignedPsbt.inputHasPubkey(i, Buffer.from(tweakedSigner.publicKey));
                if (matchingPubKey) {
    ...
    SignAllInputs({ rawPsbt, finalize, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let unSignedPsbt = bitcoin.Psbt.fromBase64(rawPsbt);
            for (let i = 0; i < unSignedPsbt.inputCount; i++) {
                const matchingPubKey = unSignedPsbt.inputHasPubkey(i, Buffer.from(this.segwitKeyPair.publicKey));
                if (matchingPubKey) {
