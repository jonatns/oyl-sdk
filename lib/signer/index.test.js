...
describe('Signer', () => {
    ...
    test('Should sign a message with nested segwit keypair', async () => {
        const signtaure = 'AkcwRAIgYNyQYcMg9q7kIWSMniPLFs+JbWbD0YiAFMLLziUkINgCIElQKraLgD4RrRJzTPmZF9GjoyxCN/aDSbzUVpIy7uZxASEDmztpS4/FteB/sGnHg8rHVPXTjD4IvtGWDjH9sd2jXCQ=';
        ...
        const verifySignature = bip322_js_1.Verifier.verifySignature(address, hashedMessage, signedMessage);
    ...
    test('Should sign a message with taproot keypair', async () => {
        const signtaure = 'AUF+il3sadlcy8h8Im305KXn3EfUP06ra9Jpn1p228xaHEGLI3T59oo/59du9fDrqd2RtTrfFtgk/O8ev0KnLERrAQ==';
        let signer = new _1.Signer(network, keys);
    ...
    test('Should sign a message with native segwit keypair', async () => {
        const signtaure = 'AkcwRAIgIVp4qcqPa5HsN5Kppc530WKw8RZXnme4irOepyYJ9O8CICo4db+aGShptCN512Pv0JY27c8xIuiPAmdK17Zh6wFxASEDMNVP0N1CCm5fjTYk9fNILK41D3nV8HU79b7vnC2Rrzw=';
        let signer = new _1.Signer(network, keys);
    ...
    test('Should sign a message with legacy keypair', async () => {
        const signtaure = 'IIFzCkVXWpRMaBySpCGfBHpPvplqo9QpdZl9NPYe3ZU3QaTv4eo/nfWtIj87Vl9kWXq6Drs45tJjtfYdXGQYoWo=';
        let signer = new _1.Signer(network, keys);
