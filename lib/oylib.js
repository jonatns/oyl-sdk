...
class Oyl {
    ...
    constructor(opts = constants_1.defaultNetworkOptions.mainnet) {
        this.createBtcTx = ({ inputAddress, outputAddress, taprootPublicKey, segwitPublicKey, segwitAddress, payFeesWithSegwit = false, feeRate, amount, network, segwitUtxos, taprootUtxos, }) => __awaiter(this, void 0, void 0, function* () {
            const psbt = new bitcoin.Psbt({ network: network });
            const inputAddressType = utils_1.addressTypeMap[(0, transactions_1.getAddressType)(inputAddress)];
            ...
            const updatedPsbt = yield (0, utils_1.insertBtcUtxo)({
            ...
            const formattedInputs = yield (0, utils_1.formatInputsToSign)({
                _psbt: updatedPsbt,
     ...
     */
    sendBtc({ to, from, amount, feeRate, publicKey, signer, segwitAddress, segwitPubkey, payFeesWithSegwit = false, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (payFeesWithSegwit) {
                ...
                const { signedPsbt: segwitSigned } = yield signer.SignAllInputs({
                    rawPsbt: signedPsbt,
                });
                finalPsbt = segwitSigned;
            }
            const inputAddressType = utils_1.addressTypeMap[(0, transactions_1.getAddressType)(from)];
            if (interface_1.addressTypeToName[inputAddressType] === 'segwit' &&
                !payFeesWithSegwit) {
                const { signedPsbt } = yield signer.SignAllInputs({
                    rawPsbt: rawPsbt,
                });
    ...
    sendBRC20(options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const { txId, commitTx, revealTx } = yield (0, utils_1.inscribe)({
                    content,
