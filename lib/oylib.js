...
class Oyl {
    ...
    constructor(options = constants_1.defaultNetworkOptions) {
        this.apiClient = new apiclient_1.OylApiClient({ host: 'https://api.oyl.gg', testnet: options.network == "testnet" ? true : null });
    ...
    initializeWallet() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const wallet = new accountsManager_1.AccountManager({ network: this.network, customPath: this.network == (0, utils_1.getNetwork)('testnet') ? 'testnet' : null });
     ...
     */
    sendBtc({ to, from, amount, feeRate, publicKey, mnemonic, segwitAddress, segwitPubkey, segwitHdPathWithIndex, taprootHdPathWithIndex, payFeesWithSegwit = true, }) {
        return __awaiter(this, void 0, void 0, function* () {
            const hdPaths = accountsManager_1.customPaths[segwitHdPathWithIndex];
    ...
    sendOrdCollectible(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const { data: collectibleData } = yield this.apiClient.getCollectiblesById(options.inscriptionId);
