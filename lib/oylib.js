...
class Oyl {
    ...
    sendBtc({ senderAddress, receiverAddress, senderPublicKey, feeRate, amount, payFeesWithSegwit, segwitFeePublicKey, signer, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (interface_1.addressTypeToName[inputAddressType] === 'segwit' && payFeesWithSegwit) {
                throw new Error('No need for this flag. Fees by default will come from sender address');
            }
            let segwitUtxos;
            let taprootUtxos;
