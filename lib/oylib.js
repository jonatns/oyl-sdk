...
class Oyl {
    ...
    getInscriptions({ address }) {
        return __awaiter(this, void 0, void 0, function* () {
            const collectibles = [];
            const brc20 = [];
            const allCollectibles = (yield this.apiClient.getCollectiblesByAddress(address)).data;
            // const allBrc20s = (
    ...
    sendBRC20(options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const { txnId, error: inscribeError } = yield (0, utils_1.inscribe)({
                    content,
                ...
                const txResult = yield (0, utils_1.waitForTransaction)(txnId, this.currentNetwork);
                if (!txResult) {
                ...
                const { result: transferSendTxId } = yield (0, utils_1.callBTCRPCEndpoint)('sendrawtransaction', sendTxHex, this.currentNetwork);
    ...
    sendOrdCollectible({ mnemonic, fromAddress, taprootPublicKey, destinationAddress, segwitPubKey, segwitAddress, payFeesWithSegwit, feeRate, inscriptionId, segwitHdPath = 'oyl', }) {
        return __awaiter(this, void 0, void 0, function* () {
