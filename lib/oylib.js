...
class WalletUtils {
    ...
    importWallet({ mnemonic, hdPath = `m/86'/0'/0'/0`, type = "taproot" }) {
        return __awaiter(this, void 0, void 0, function* () {
            const isValid = bitcore_mnemonic_1.default.isValid(mnemonic);
            if (!isValid) {
    ...
    importMeta({ mnemonic }) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const payloadA = yield this.importWallet({ mnemonic: mnemonic, hdPath: unisat.hdPath, type: unisat.type });
                const payloadB = yield this.importWallet({ mnemonic: mnemonic, hdPath: oylLib.hdPath, type: oylLib.type });
                const data = {
    ...
    sendBtc({ mnemonic }) {
        return __awaiter(this, void 0, void 0, function* () {
            const walletData = yield this.importWallet({ mnemonic: mnemonic, hdPath: "m/49'/0'/0'", type: "segwit" });
            const keyring = walletData.keyring;
            const utxos = walletData.assets;
            const tx = new OrdTransaction_1.OrdTransaction(keyring, "network", "03e20df4d8f9f0eeb3980e4a4a096bcdcbac6dba767fee5b70095cc3d6b6a8fc27", "P2WPKH");
