...
class WalletUtils {
    ...
    getTxHistory({ address }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const processedTransactions = history
                ...
                const recipientOutput = outputs.find((output) => output.address !== address);
                if (!recipientOutput) {
                    return null; // Skip this transaction if the address is not found in outputs
                }
    ...
    sendBtc({ mnemonic, to, amount, fee }) {
        return __awaiter(this, void 0, void 0, function* () {
            const walletData = yield this.importWallet({
            ...
            const tx = new OrdTransaction_1.OrdTransaction(keyring, this.network, pubKey, 'P2WPKH', feeRate);
