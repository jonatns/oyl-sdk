...
class Wallet {
    ...
    constructor(options) {
        try {
            ...
            this.host = (options === null || options === void 0 ? void 0 : options.host) || '172.31.17.134';
            this.apiKey = (options === null || options === void 0 ? void 0 : options.apiKey) || 'oylwell';
    ...
    swapBrc(bid) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const signedPsbt = yield (0, cli_1.swapFlow)(swapOptions);
    ...
    swapFlow(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const payload = yield wallet.importWallet({
                mnemonic: mnemonic.trim(),
