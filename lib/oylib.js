        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const processedTxPromises = history
                ...
                if (input) {
                    ...
                    if (output) {
                        txDetails['amount'] = input.coin ? input.coin.value / 1e8 - output.value / 1e8 : (yield this.getTxValueFromPrevOut(inputs, address)) / 1e8 - output.value / 1e8;
                    }
                    else {
                        txDetails['amount'] = input.coin ? input.coin.value / 1e8 : (yield this.getTxValueFromPrevOut(inputs, address)) / 1e8;
                    }
                }
                else {
                    if (output) {
  ...
  */
    ...
    signInscriptionPsbt({ psbt, fee }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const tx = new txbuilder_1.PSBTTransaction(signer, from, pubKey, addressType, fee);
