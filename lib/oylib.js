...
class Wallet {
     ...
     */
    createPsbtTx({ publicKey, from, to, changeAddress, amount, feeRate, signer, isDry = false, }) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield this.apiClient.pushTx({ transactionHex: txId });
                return Object.assign({ txId }, result);
            }
            catch (error) {
                console.error(error);
            }
