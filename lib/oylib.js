...
class Oyl {
     ...
     * @returns {Promise<Object>} A promise that resolves to an object containing transaction ID and other response data from the API client.
     */
    createBtcTx({ to, from, amount, feeRate, publicKey, mnemonic, segwitAddress, segwitPubkey, segwitHdPathWithIndex, taprootHdPathWithIndex, payFeesWithSegwit = true, }) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield (0, utils_1.sendBtc)({
                    inputAddress: from,
                    outputAddress: to,
                    amount: amount,
                    feeRate: feeRate,
