...
class Wallet {
     ...
     */
    createOrdPsbtTx({ publicKey, fromAddress, toAddress, changeAddress, txFee, signer, segwitAddress, segwitPubKey, segwitSigner, inscriptionId, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const psbtTx = new txbuilder_1.PSBTTransaction(signer, segwitSigner, segwitPubKey, segwitAddressType, fromAddress, publicKey, addressType, feeRate);
