...
class Wallet {
    ...
    createOrdPsbtTx({ fromAddress, toAddress, changeAddress, txFee, segwitAddress, taprootPubKey, segwitPubKey, inscriptionId, mnemonic, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const feeRate = txFee;
            const psbtTx = new txbuilder_1.PSBTTransaction(signer, fromAddress, taprootPubKey, addressType, feeRate, segwitSigner, segwitPubKey);
            psbtTx.setChangeAddress(changeAddress);
            const finalizedPsbt = yield (0, txbuilder_1.buildOrdTx)(psbtTx, segwitUtxos, allUtxos, segwitAddress, toAddress, metaOutputValue, feeRate, inscriptionId);
            //@ts-ignore
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (totalUnspentAmount < estimatedNetworkFee) {
                    new Error(`Not enough balance. Need ${(0, utils_1.satoshisToAmount)(estimatedNetworkFee)} BTC as network fee, but only ${(0, utils_1.satoshisToAmount)(totalUnspentAmount)} BTC is available.`);
                }
