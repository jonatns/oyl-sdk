...
class Wallet {
    ...
    createOrdPsbtTx({ fromAddress, toAddress, changeAddress, txFee, segwitAddress, taprootPubKey, segwitPubKey, inscriptionId, mnemonic, }) {
        return __awaiter(this, void 0, void 0, function* () {
            console.log(`creating ord psbt for pubkeys: taproot ${(0, hdKeyring_1.truncateString)(taprootPubKey, 12)} and native segwit ${(0, hdKeyring_1.truncateString)(segwitPubKey, 12)}`);
            ...
            // console.log({segwitKeyring})
            // console.log({tapKeyring})
            ...
            //   inscriptionId
            // )
            yield (0, txbuilder_1.buildOrdTx)(psbtTx, segwitUtxos, allUtxos, segwitAddress, toAddress, metaOutputValue, inscriptionId);
