...
class Wallet {
    ...
    initializeWallet(mnemonic) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const wallet = new accountsManager_1.AccountManager(mnemonic);
  ...
  */
    createOrdPsbtTx({ publicKey, fromAddress, toAddress, changeAddress, txFee, signer, inscriptionId, metaOffset, metaOutputValue = 10000, }) {
        return __awaiter(this, void 0, void 0, function* () {
