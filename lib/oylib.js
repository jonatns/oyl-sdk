...
class Wallet {
    ...
    createOrdPsbtTx({ publicKey, fromAddress, toAddress, changeAddress, txFee, segwitAddress, segwitPubKey, inscriptionId, mnemonic, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const psbtTx = new txbuilder_1.PSBTTransaction(signer, fromAddress, publicKey, addressType, feeRate, segwitSigner, segwitPubKey, segwitAddressType);
            psbtTx.setChangeAddress(changeAddress);
            const finalizedPsbt = yield (0, txbuilder_1.buildOrdTx)(psbtTx, segwitUtxos, allUtxos, segwitAddress, toAddress, metaOutputValue, inscriptionId);
