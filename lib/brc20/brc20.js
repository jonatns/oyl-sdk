...
exports.addressBRC20Utxos = exports.send = exports.transfer = exports.reveal = exports.commit = exports.transferEstimate = void 0;
...
exports.send = send;
const addressBRC20Utxos = async ({ address, provider, }) => {
    let totalAmount = 0;
    ...
    const currentBlock = await provider.sandshrew.bitcoindRpc.getBlockCount();
...
exports.addressBRC20Utxos = addressBRC20Utxos;
