...
exports.validateSegwitAddress = exports.validateTaprootAddress = exports.getAddressType = exports.getMetaUtxos = exports.convertUsdValue = exports.calculateBalance = exports.getBtcPrice = exports.getUnspentOutputs = void 0;
...
function getAddressType(address) {
    if (accounts_1.addressFormats.mainnet.p2pkh.test(address) || accounts_1.addressFormats.testnet.p2pkh.test(address) || accounts_1.addressFormats.regtest.p2pkh.test(address)) {
        return interface_1.AddressType.P2PKH;
    }
    else if (accounts_1.addressFormats.mainnet.p2tr.test(address) || accounts_1.addressFormats.testnet.p2tr.test(address) || accounts_1.addressFormats.regtest.p2tr.test(address)) {
        return interface_1.AddressType.P2TR;
    }
    else if (accounts_1.addressFormats.mainnet.p2sh.test(address) || accounts_1.addressFormats.testnet.p2sh.test(address) || accounts_1.addressFormats.regtest.p2sh.test(address)) {
        return interface_1.AddressType.P2SH_P2WPKH;
    }
    else if (accounts_1.addressFormats.mainnet.p2wpkh.test(address) || accounts_1.addressFormats.testnet.p2wpkh.test(address) || accounts_1.addressFormats.regtest.p2wpkh.test(address)) {
