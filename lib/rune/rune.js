...
exports.etch = exports.mint = exports.send = exports.actualEtchFee = exports.actualMintFee = exports.actualSendFee = exports.findRuneUtxos = exports.createEtchPsbt = exports.createMintPsbt = exports.createSendPsbt = exports.createRuneMintScript2 = void 0;
...
const createRuneMintScript2 = ({ runeId, pointer = 1, }) => {
...
exports.createRuneMintScript2 = createRuneMintScript2;
...
const createMintPsbt = async ({ account, runeId, provider, amount, feeRate, fee, }) => {
    try {
        ...
        const minstScript = (0, exports.createRuneMintScript2)({
            runeId,
            pointer: 0,
        });
