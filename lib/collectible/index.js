...
const createPsbt = async ({ account, inscriptionId, provider, inscriptionAddress, toAddress, feeRate, fee, }) => {
    try {
        ...
        if ((0, transactions_1.getAddressType)(inscriptionAddress) === 0) {
        ...
        if ((0, transactions_1.getAddressType)(inscriptionAddress) === 2) {
        ...
        if ((0, transactions_1.getAddressType)(inscriptionAddress) === 1 ||
            (0, transactions_1.getAddressType)(inscriptionAddress) === 3) {
            psbt.addInput({
                hash: txId,
                index: parseInt(voutIndex),
                witnessUtxo: {
