...
const createPsbt = async ({ account, inscriptionId, provider, toAddress, feeRate, fee, }) => {
    try {
...
const send = async ({ account, inscriptionId, provider, toAddress, feeRate, signer, }) => {
...
exports.send = send;
const actualFee = async ({ account, inscriptionId, provider, toAddress, feeRate, signer, }) => {
    const { psbt } = await (0, exports.createPsbt)({
        account,
        inscriptionId,
        provider,
