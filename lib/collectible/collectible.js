...
const createPsbt = async ({ gatheredUtxos, account, inscriptionId, provider, inscriptionAddress, toAddress, feeRate, fee, }) => {
    try {
        ...
        if (!gatheredUtxos) {
            ...
            gatheredUtxos = (0, utils_1.findXAmountOfSats)(accountSpendableTotalUtxos, Number(finalFee));
        }
        gatheredUtxos = (0, utils_1.findXAmountOfSats)(gatheredUtxos.utxos, Number(finalFee));
