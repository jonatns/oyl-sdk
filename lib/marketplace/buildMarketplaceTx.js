...
class BuildMarketplaceTransaction {
    constructor({ address, pubKey, psbtBase64, price, network }) {
        var _a;
        this.walletAddress = address;
        this.pubKey = pubKey;
        /** should resolve values below based on network passed */
        this.api = new apiclient_1.OylApiClient({ host: 'https://api.oyl.gg' });
        this.esplora = new esplora_1.EsploraRpc("https://mainnet.sandshrew.io/v1/154f9aaa25a986241357836c37f8d71");
        this.sandshrew = new sandshrew_1.SandshrewBitcoinClient("https://sandshrew.io/v1/d6aebfed1769128379aca7d215f0b689");
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                "=========== Getting all confirmed/unconfirmed utxos for " +
                    this.walletAddress +
                    " ============";
                return yield this.esplora.getAddressUtxo(this.walletAddress)
                    .then((unspents) => unspents === null || unspents === void 0 ? void 0 : unspents.filter((utxo) => utxo.status.confirmed == true || utxo.status.confirmed == false));
            }
            catch (e) {
                throw new Error(e);
            }
