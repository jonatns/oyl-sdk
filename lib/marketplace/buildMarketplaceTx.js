...
class BuildMarketplaceTransaction {
    constructor({ address, pubKey, psbtBase64, price, wallet, dryRun, }) {
        var _a, _b;
        if (dryRun) {
            ...
            if (addressType == interface_1.AddressType.P2TR) {
                console.log('taker script', (_a = p2tr.output) === null || _a === void 0 ? void 0 : _a.toString('hex'));
                this.takerScript = (_b = p2tr.output) === null || _b === void 0 ? void 0 : _b.toString('hex');
            }
            else {
