...
class Marketplace {
    ...
    getSignatureForBind() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const keyToUse = (0, __1.getAddressType)(this.receiveAddress) == __1.AddressType.P2TR ? "taprootKeyPair" : "segwitKeyPair";
            const options = { address: this.receiveAddress, message: toSignStr };
            const payload = (0, jsontokens_1.createUnsecuredToken)(options);
            const signature = yield this.signer.signMessage({ messageToSign: payload, keyToUse });
