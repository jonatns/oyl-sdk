...
class Marketplace {
    ...
    buyMarketPlaceOffers(pOffers) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < multipleBuys.psbtHexs.length; i++) {
                yield (0, __1.timeout)(30000);
                const [broadcast] = yield this.wallet.sandshrewBtcClient.bitcoindRpc.testMemPoolAccept([multipleBuys.psbtHexs[i]]);
                if (!broadcast.allowed) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const offer of offers) {
                if (offer.marketplace == 'omnisat') {
                    let newOffer = yield this.wallet.apiClient.getOmnisatOfferPsbt({ offerId: offer.offerId, ticker: offer.ticker, testnet });
                    if (newOffer == false) {
    ...
    externalSign(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const psbt_ = yield tx.signPsbt(psbt, false, false, options.indexToSign);
            return psbt_.toHex();
        });
    }
    /**
