    ...
    getSignatureForBind() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((0, __1.getAddressType)(this.receiveAddress) == __1.AddressType.P2WPKH) {
                ...
                const signature = (0, bitcoinjs_message_1.sign)(message, privateKey, keyPair.compressed, { segwitType: 'p2wpkh' });
                return signature.toString('hex');
            }
            else if ((0, __1.getAddressType)(this.receiveAddress) == __1.AddressType.P2TR) {
                const keyPair = this.signer.taprootKeyPair;
                const privateKey = keyPair.privateKey;
                const signature = (0, bitcoinjs_message_1.sign)(message, privateKey, keyPair.compressed);
                return signature.toString('hex');
            }
        });
    }
