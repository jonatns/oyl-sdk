...
class Marketplace {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const offer of offers) {
                if (offer.marketplace == 'omnisat') {
                    ...
                    const offerPsbt = yield this.wallet.apiClient.getOkxOfferPsbt({ offerId: offer.offerId });
                    const signedPsbt = yield this.createOkxSignedPsbt(offerPsbt.data.sellerPsbt, offer.totalPrice);
                    const payload = {
                        ticker: offer.ticker,
                    ...
                    const tx = yield this.wallet.apiClient.submitOkxBid(payload);
                    let txId = tx === null || tx === void 0 ? void 0 : tx.data;
                    if (txId != null)
                        processedOffers.push(txId);
                    externalSwap = true;
                }
    ...
    externalSwap(bid) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.selectedSpendAddress != this.receiveAddress && !this.addressesBound) {
                const signature = yield this.getSignatureForBind();
                payload["signature"] = signature;
                this.addressesBound = true;
            }
            const psbt = yield this.wallet.apiClient.initSwapBid(payload);
    ...
    getUTXOsToCoverAmount(address, amountNeeded, excludedUtxos = [], inscriptionLocs) {
        var _a, e_1, _b, _c;
        return __awaiter(this, void 0, void 0, function* () {
            try {
    ...
    getAllUTXOsWorthASpecificValue(value) {
        return __awaiter(this, void 0, void 0, function* () {
            const unspents = yield this.getUnspentsForAddress(this.selectedSpendAddress);
            console.log('=========== Confirmed/Unconfirmed Utxos Len', unspents.length);
            return unspents.filter((utxo) => utxo.value === value);
        });
    }
    buildDummyAndPaymentUtxos(orderPrice) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const retrievedUtxos = yield this.getUTXOsToCoverAmount(this.selectedSpendAddress, requiredSatoshis, dummyUtxos);
    ...
    createOkxSignedPsbt(sellerPsbt, orderPrice) {
        return __awaiter(this, void 0, void 0, function* () {
            const marketPlaceBuy = new buildMarketplaceTx_1.BuildMarketplaceTransaction({
                address: this.selectedSpendAddress,
                pubKey: this.selectedSpendPubkey,
            ...
            const keyPair = ((0, __1.getAddressType)(this.selectedSpendAddress) == __1.AddressType.P2WPKH) ? this.signer.segwitKeyPair : this.signer.taprootKeyPair;
            const privateKey = keyPair.toWIF();
            const data = yield this.buildDummyAndPaymentUtxos(orderPrice);
    ...
    getSignatureForBind() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((0, __1.getAddressType)(this.receiveAddress) == __1.AddressType.P2WPKH) {
                ...
                const privateKey = keyPair.toWIF();
                const signature = bip322_js_1.Signer.sign(privateKey, this.receiveAddress, message);
