...
const signBip322Message = ({ message, network, privateKey, signatureAddress, }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (type === bitcoin_address_validation_1.AddressType.p2sh) {
        return (yield (0, bitcoinjs_message_1.signAsync)(message, privateKey, false, { segwitType: 'p2sh(p2wpkh)' })).toString('base64');
    }
    ...
    txToSign.sign(base_1.hex.decode(privateKey));
    txToSign.finalize();
    // formulate-signature
