...
const nodeClient = new rpclient_1.default(clientOptions);
(() => __awaiter(void 0, void 0, void 0, function* () {
    const walletUtil = new oylib_1.WalletUtils();
    console.log(`Getting Address summary of ${addressWithBal}`, yield walletUtil.getAddressSummary({ address: [addressWithBal] }));
