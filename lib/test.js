...
(async () => {
    ...
    console.log(`Getting Inscription by tx hash: ${hashWithInscription}`, await wallet_1.bord.getInscriptionByHash(hashWithInscription));
    console.log(`Getting Inscription by address of ${addressWithBal}`, await wallet_1.bord.getInscriptionsByAddr(addressWithBal));
})();
