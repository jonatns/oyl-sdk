...
describe('Account Tests', () => {
    ...
    it('mnemonicToAccount throws error if mnemonic is invalid', () => {
        expect(() => (0, account_1.mnemonicToAccount)({ mnemonic: 'invalid mnemonic' })).toThrow(Error);
    });
    it('getWalletPrivateKeys throws error if mnemonic is invalid', () => {
        expect(() => (0, account_1.getWalletPrivateKeys)({ mnemonic: 'invalid mnemonic' })).toThrow(Error);
    });
    it('getWalletPrivateKeys throws error if mnemonic is invalid', () => {
        expect(() => (0, account_1.getWalletPrivateKeys)({ mnemonic: 'invalid mnemonic' })).toThrow(Error);
    });
