...
const createBtcTx = ({ inputAddress, outputAddress, mnemonic, taprootPublicKey, segwitPublicKey, segwitAddress, isDry, segwitHdPathWithIndex, taprootHdPathWithIndex, payFeesWithSegwit, feeRate, amount, }) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const wallet = new oylib_1.Oyl();
        const psbt = new bitcoin.Psbt();
        const taprootUtxos = yield wallet.getUtxosArtifacts({
