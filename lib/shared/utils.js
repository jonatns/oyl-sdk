...
const inscribe = ({ ticker, amount, inputAddress, outputAddress, mnemonic, taprootPublicKey, segwitPublicKey, segwitAddress, isDry, segwitHdPathWithIndex, taprootHdPathWithIndex, payFeesWithSegwit = true, feeRate, }) => __awaiter(void 0, void 0, void 0, function* () {
...
const sendCollectible = ({ inscriptionId, inputAddress, outputAddress, mnemonic, taprootPublicKey, segwitPublicKey, segwitAddress, isDry, segwitHdPathWithIndex, taprootHdPathWithIndex, payFeesWithSegwit = true, feeRate, }) => __awaiter(void 0, void 0, void 0, function* () {
    //const fastestFee = await getRecommendedBTCFeesMempool()
    try {
        const wallet = new oylib_1.Oyl();
        const psbt = new bitcoin.Psbt();
...
const createBtcTx = ({ inputAddress, outputAddress, mnemonic, taprootPublicKey, segwitPublicKey, segwitAddress, isDry, segwitHdPathWithIndex, taprootHdPathWithIndex, payFeesWithSegwit = true, feeRate, amount, }) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const wallet = new oylib_1.Oyl();
        const psbt = new bitcoin.Psbt();
        const taprootUtxos = yield wallet.getUtxosArtifacts({
