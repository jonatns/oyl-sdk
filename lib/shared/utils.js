...
exports.delay = delay;
function createSegwitSigner({ mnemonic, segwitAddress, segwitPubKey, }) {
...
function createTaprootSigner({ mnemonic, taprootAddress, }) {
    return __awaiter(this, void 0, void 0, function* () {
...
const inscribe = ({ ticker, amount, inputAddress, outputAddress, mnemonic, taprootPublicKey, segwitPublicKey, segwitAddress, isDry, }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const commitTxPsbt = bitcoin.Psbt.fromHex(commitHex);
...
exports.createP2PKHRedeemScript = createP2PKHRedeemScript;
function createP2SHP2PKHRedeemScript(publicKeyHex) {
    const publicKeyBuffer = Buffer.from(publicKeyHex, 'hex');
    const publicKeyHash = bitcoin.crypto.hash160(publicKeyBuffer);
    return bitcoin.script.compile([
        bitcoin.opcodes.OP_DUP,
...
exports.createP2SHP2PKHRedeemScript = createP2SHP2PKHRedeemScript;
