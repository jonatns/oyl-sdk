...
exports.getUnfinalizedPsbtTxId = exports.addInputUtxosToPsbt = exports.readU128LE = exports.packUTF8 = exports.getVSize = exports.decodeCBOR = exports.findXAmountOfSats = exports.findRuneUtxosToSpend = exports.encodeVarint = exports.isValidJSON = exports.filterUtxos = exports.filterTaprootUtxos = exports.calculateTaprootTxSize = exports.getOutputValueByVOutIndex = exports.waitForTransaction = exports.getAddressKey = exports.getAddressType = exports.createRuneEtchScript = exports.createRuneMintScript = exports.createRuneSendScript = exports.hexToLittleEndian = exports.runeFromStr = exports.encodeToBase26 = exports.createInscriptionScript = exports.signInputs = exports.timeout = exports.formatInputsToSign = exports.internalPubKeyToTaprootAddress = exports.formatInputToSign = exports.addressToScriptPk = exports.calculateAmountGatheredUtxo = exports.calculateAmountGathered = exports.getWitnessDataChunk = exports.utxoToInput = exports.validator = exports.amountToSatoshis = exports.delay = exports.satoshisToAmount = exports.tweakSigner = exports.getFee = exports.getNetwork = exports.hashTapLeaf = exports.tweakPublicKey = exports.assertHex = exports.ECPair = exports.inscriptionSats = exports.addressTypeMap = void 0;
...
function tweakPublicKey(internalPubkey, scriptHash) {
    const tweakHash = tapTweakHash(internalPubkey, scriptHash);
    const tweakedPubkey = secp256k1_1.default.pointAddScalar(Buffer.from(internalPubkey), tweakHash, true);
    if (!tweakedPubkey) {
...
function hashTapLeaf(script, leafVersion = 0xc0) {
    return bitcoin.crypto.taggedHash('TapLeaf', Buffer.concat([Buffer.from([leafVersion]), script]));
}
...
const formatInputToSign = async ({ v, senderPublicKey, network, }) => {
    ...
    if (!isSigned || lostInternalPubkey) {
        ...
        const tapInternalKey = (0, bip371_1.toXOnly)(keyBuffer);
...
exports.formatInputToSign = formatInputToSign;
function internalPubKeyToTaprootAddress(internalPubkey, network) {
...
exports.internalPubKeyToTaprootAddress = internalPubKeyToTaprootAddress;
const formatInputsToSign = async ({ _psbt, senderPublicKey, network, }) => {
    let index = 0;
    for await (const v of _psbt.data.inputs) {
        (0, exports.formatInputToSign)({ v, senderPublicKey, network });
        index++;
    }
    return _psbt;
};
...
async function waitForTransaction({ txId, sandshrewBtcClient, esploraClient, }) {
    ...
    while (true) {
        try {
            ...
            if (Date.now() - startTime > timeout) {
                throw new Error(`Timeout: Could not find transaction in mempool or confirmed: ${txId}`);
            }
...
async function addInputUtxosToPsbt(utxos, psbt, account, provider) {
    for await (const utxo of utxos) {
        ...
        if (getAddressType(utxo.address) === 1 ||
...
exports.addInputUtxosToPsbt = addInputUtxosToPsbt;
const getUnfinalizedPsbtTxId = (psbt) => {
...
exports.getUnfinalizedPsbtTxId = getUnfinalizedPsbtTxId;
