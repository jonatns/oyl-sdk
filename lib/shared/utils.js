...
const formatOptionsToSignInputs = ({ _psbt, isRevealTx, pubkey, segwitPubkey, }) => __awaiter(void 0, void 0, void 0, function* () {
    let toSignInputs = [];
...
const inscribe = ({ ticker, amount, inputAddress, outputAddress, mnemonic, taprootPublicKey, segwitPublicKey, segwitAddress, isDry, }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield (0, exports.signInputs)(psbt, toSignInputs, taprootPublicKey, segwitPublicKey, segwitSigner, taprootSigner);
