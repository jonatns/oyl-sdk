...
const formatInputsToSign = ({ _psbt, pubkey, segwitPubkey, segwitAddress, taprootAddress, network, }) => __awaiter(void 0, void 0, void 0, function* () {
    var _j, e_2, _k, _l;
    var _m, _o;
    let index = 0;
    try {
...
const createBtcTx = ({ inputAddress, outputAddress, mnemonic, taprootPublicKey, segwitPublicKey, segwitAddress, isDry, payFeesWithSegwit = false, feeRate, amount, network, segwitUtxos, taprootUtxos, }) => __awaiter(void 0, void 0, void 0, function* () {
