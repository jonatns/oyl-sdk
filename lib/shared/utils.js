...
const createBtcTx = ({ inputAddress, outputAddress, mnemonic, taprootPublicKey, segwitPublicKey, segwitAddress, payFeesWithSegwit = false, feeRate, amount, network, segwitUtxos, taprootUtxos, }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updatedPsbt = yield insertBtcUtxo({
        taprootUtxos: taprootUtxos,
        segwitUtxos: segwitUtxos,
        psbt: psbt,
        toAddress: outputAddress,
    ...
    const formattedInputs = yield (0, exports.formatInputsToSign)({
        _psbt: updatedPsbt,
        pubkey: taprootPublicKey,
        taprootAddress: inputAddress,
        network,
