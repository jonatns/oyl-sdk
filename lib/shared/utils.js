...
exports.delay = delay;
function createSegwitSigner({ mnemonic, segwitAddress, hdPathWithIndex, }) {
    return __awaiter(this, void 0, void 0, function* () {
        if (segwitAddress) {
            let payload;
            const wallet = new oylib_1.Oyl();
            const segwitAddressType = (0, transactions_1.getAddressType)(segwitAddress);
            if (segwitAddressType == null) {
                throw Error('Unrecognized Address Type');
            }
            payload = yield wallet.fromPhrase({
...
exports.createSegwitSigner = createSegwitSigner;
function createTaprootSigner({ mnemonic, taprootAddress, hdPathWithIndex, }) {
    return __awaiter(this, void 0, void 0, function* () {
...
exports.createTaprootSigner = createTaprootSigner;
function createSigner({ mnemonic, fromAddress, hdPathWithIndex, }) {
    return __awaiter(this, void 0, void 0, function* () {
...
const formatOptionsToSignInputs = ({ _psbt, isRevealTx, pubkey, segwitPubkey, segwitAddress, taprootAddress, }) => __awaiter(void 0, void 0, void 0, function* () {
    var _j, e_3, _k, _l;
    var _m, _o;
    let toSignInputs = [];
...
const inscribe = ({ ticker, amount, inputAddress, outputAddress, mnemonic, taprootPublicKey, segwitPublicKey, segwitAddress, isDry, segwitHdPathWithIndex, taprootHdPathWithIndex, payFeesWithSegwit, feeRate, }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const taprootUtxos = yield wallet.getUtxosArtifacts({
            address: inputAddress,
        });
        let segwitUtxos;
        if (segwitAddress) {
            segwitUtxos = yield wallet.getUtxosArtifacts({
        ...
        const taprootSigner = yield createTaprootSigner({
            mnemonic: mnemonic,
            taprootAddress: inputAddress,
            hdPathWithIndex: taprootHdPathWithIndex,
        });
        const segwitSigner = yield createSegwitSigner({
            mnemonic: mnemonic,
            segwitAddress: segwitAddress,
        ...
        if (!isDry) {
            return yield (0, exports.callBTCRPCEndpoint)('sendrawtransaction', tapscript_1.Tx.encode(txData).hex);
        }
        else {
            console.log({ result: tapscript_1.Tx.util.getTxid(txData) }, tapscript_1.Tx.encode(txData).hex);
            return { result: tapscript_1.Tx.util.getTxid(txData) };
        }
    }
    catch (e) {
...
const sendCollectible = ({ inscriptionId, inputAddress, outputAddress, mnemonic, taprootPublicKey, segwitPublicKey, segwitAddress, isDry, segwitHdPathWithIndex, taprootHdPathWithIndex, payFeesWithSegwit, feeRate, }) => __awaiter(void 0, void 0, void 0, function* () {
    //const fastestFee = await getRecommendedBTCFeesMempool()
    try {
        const wallet = new oylib_1.Oyl();
        const psbt = new bitcoin.Psbt();
        ...
        const { data: collectibleData } = yield new oylib_1.Oyl().apiClient.getCollectiblesById(inscriptionId);
        ...
        if (isDry) {
            ...
            const { result } = yield (0, exports.callBTCRPCEndpoint)('sendrawtransaction', txnHash);
            txnId = result;
            console.log(txnId);
            return txnId;
        }
...
const insertCollectibleUtxo = ({ taprootUtxos, inscriptionId, toAddress, psbt, }) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield (0, buildOrdTx_1.addInscriptionUtxo)({
            metaUtxos: metaUtxos,
            inscriptionId: inscriptionId,
            toAddress: toAddress,
            psbtTx: psbt,
...
const insertBtcUtxo = ({ taprootUtxos, segwitUtxos, toAddress, fromAddress, psbt, amount, sendFromSegwit, segwitPubKey, }) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let nonMetaUtxos;
        if (sendFromSegwit) {
...
const addBTCUtxo = ({ utxos, toAddress, psbtTx, amount, fromAddress, segwitPubKey, }) => __awaiter(void 0, void 0, void 0, function* () {
...
const sendBtc = ({ inputAddress, outputAddress, mnemonic, taprootPublicKey, segwitPublicKey, segwitAddress, isDry, segwitHdPathWithIndex, taprootHdPathWithIndex, payFeesWithSegwit, feeRate, amount, }) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const wallet = new oylib_1.Oyl();
        const psbt = new bitcoin.Psbt();
        const taprootUtxos = yield wallet.getUtxosArtifacts({
        ...
        const isSentFromSegwit = interface_1.addressTypeToName[inputAddressType] === 'nested-segwit' || 'segwit'
            ? true
            : false;
        const utxoToSend = yield insertBtcUtxo({
            taprootUtxos: taprootUtxos,
            segwitUtxos: segwitUtxos,
            psbt: psbt,
            toAddress: outputAddress,
        ...
        const txnHash = signedPsbt.extractTransaction().toHex();
        let txnId = signedPsbt.extractTransaction().getId();
        const testTxAccept = yield (0, exports.callBTCRPCEndpoint)('bcli_testmempoolaccept', [
            `${txnHash}`,
        ]);
