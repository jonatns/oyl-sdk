...
export declare const addBtcUtxo: ({ spendUtxos, toAddress, psbt, amount, feeRate, network, spendAddress, spendPubKey, altSpendAddress, altSpendPubKey, altSpendUtxos, fee }: {
    spendUtxos: any[];
    toAddress: string;
    psbt: bitcoin.Psbt;
    feeRate: number;
