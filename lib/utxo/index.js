...
exports.findCollectible = exports.findUtxosToCoverAmount = exports.accountSpendableUtxos = exports.addressSpendableUtxos = void 0;
...
const findUtxosToCoverAmount = (utxos, amount) => {
    let totalSatoshis = 0;
    const selectedUtxos = [];
...
const findCollectible = async ({ account, provider, inscriptionId, }) => {
