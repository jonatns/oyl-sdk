...
exports.selectAlkanesUtxos = exports.selectSpendableUtxos = exports.selectUtxos = exports.accountUtxos = exports.addressUtxos = exports.mapAlkanesById = exports.addressBalance = exports.accountBalance = void 0;
...
const addressUtxos = async ({ address, provider, spendStrategy, }) => {
    ...
    for (const { utxo, txOutput, scriptPk, alkanesOutpoints } of processedUtxos) {
        ...
        const alkanes = (0, exports.mapAlkanesById)(alkanesOutpoints);
