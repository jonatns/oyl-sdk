...
const alkane_1 = require("../cli/alkane");
const utils_1 = require("alkanes/jsonrpc/lib/utils");
...
class AlkanesRpc {
    ...
    async _metashrewCall(method, params = []) {
        const rpc = new alkanes_rpc.AlkanesRpc({ baseUrl: alkane_1.metashrew.get() });
        return (0, utils_1.mapToPrimitives)(await rpc[method.split('_')[1]]((0, utils_1.unmapFromPrimitives)(params[0] || {})));
    }
    async _call(method, params = []) {
        if (alkane_1.metashrew.get() !== null && method.match("alkanes_")) {
