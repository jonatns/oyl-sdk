    ...
    switch (command) {
        ...
        case 'send':
            const res = await networkConfig.wallet.sendBtc({
                toAddress: 'tb1pdz8aul7226284e57e9yn4mpyd8f52zpxc7z0gz392e6amrf0s4uq6s3sw6',
                feeRate: 47,
                amount: 500,
        ...
        case 'send-collectible':
            const sendInscriptionResponse = await networkConfig.wallet.sendOrdCollectible({
                signer,
                inscriptionId: '0d039cdbcb23a119b9c7841394ce8e1ffd7b1aadb292e7b88802f2881077ce2fi0',
                feeRate: 57,
                fromAddress: networkConfig.taprootAddress,
                fromPubKey: networkConfig.taprootPubKey,
                toAddress: 'tb1pdz8aul7226284e57e9yn4mpyd8f52zpxc7z0gz392e6amrf0s4uq6s3sw6',
        ...
        case 'send-rune':
            const sendRuneResponse = await networkConfig.wallet.sendRune({
                runeId: '2585328:8',
                toAddress: 'tb1pdykkv4ldhmw2n9mpehffjk7dszltheqkhjtg3hj7p97u33jja8cq4fuph7',
                signer,
                amount: 400,
                feeRate: 40,
                fromAddress: networkConfig.taprootAddress,
