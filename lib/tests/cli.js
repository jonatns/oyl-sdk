...
const config = {
    ...
    [TESTNET]: {
        mnemonic: 'rich baby hotel region tape express recipe amazing chunk flavor oven obtain',
        wallet: testWallet,
        segwitPrivateKey: '60fb403231a1c9606a2207b6e43b3d1c22f04199bed4c4c96313fb4d7f40b0e0',
        segwitHdPath: signer_1.pathSegwit,
        taprootPrivateKey: 'd63f19f6b4f6e1e6b9fdc9dc2cb1942f1a15409e064b73ea10176e9155c9b3c2',
        taprootHdPath: signer_1.pathTaproot,
...
function runCLI() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        switch (command) {
            ...
            case 'send':
                const { rawPsbt } = yield networkConfig.wallet.sendBtc({
                    mnemonic,
                    to,
                ...
                const newSigner = new signer_1.Signer(bitcoin.networks.testnet, [
                    {
                ...
                const { signedPsbt } = yield newSigner.SignTaprootInput({
                    inputNumber: 0,
                    rawPsbt: rawPsbt,
                });
                const sendResponse = yield testWallet.pushPsbt({ psbtBase64: signedPsbt });
