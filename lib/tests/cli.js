...
async function runCLI() {
    ...
    switch (command) {
        ...
        case 'new-account':
            ...
            const result = await exports.provider.pushPsbt({
        ...
        case 'new-brc-20-send':
            ...
            const { txId: commitTxId } = await exports.provider.pushPsbt({
            ...
            const { txId: revealTxId } = await exports.provider.pushPsbt({
            ...
            const { psbt: finalTransferPsbt } = await (0, brc20_1.transfer)({
                ...
                revealTxId: revealTxId,
                commitChangeUtxoId: commitTxId,
                toAddress: 'bc1pv36jv053lqqxkr3y605mh0x78vren6fh0d2l2w5wn4l77kyxfk7q85d04u',
                fee: transferFee,
            });
            ...
            const { txId: transferTxId } = await exports.provider.pushPsbt({
