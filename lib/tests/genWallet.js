...
dotenv.config();
const generateWallet = (testnet, mnemonic, index) => {
...
(0, exports.generateWallet)(true, process.env.MAINNET_MNEMONIC //'rich baby hotel region tape express recipe amazing chunk flavor oven obtain'
);
