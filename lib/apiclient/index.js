...
class OylApiClient {
     ...
     */
    async getAirheadsMintStatus({ buyerAddress, collectionId, }) {
     ...
     * @param collectionId - the collection id.
     */
    async claimAirhead({ account, feeRate, gatheredUtxos, collectionId, }) {
     ...
     */
    async submitAirheadClaim({ buyerAddress, psbt, collectionId, listingId, }) {
