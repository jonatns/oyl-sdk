...
class OylApiClient {
    ...
    getBtcPrice() {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this._call('/get-bitcoin-price', 'post', {
                ticker: null,
            });
            return response;
        });
    ...
    getBitcoinMarketWeekly() {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this._call('/get-bitcoin-market-weekly', 'post', {
                ticker: null,
            });
            return response;
        });
    ...
    getBitcoinMarkets() {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this._call('/get-bitcoin-markets', 'post', {
                ticker: null,
            });
            return response;
        });
    ...
    sendBtcEstimate({ feeRate, amount, altSpendPubKey, spendAddress, spendPubKey, altSpendAddress, testnet, }) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._call('/send-btc-estimate', 'post', {
                feeRate,
                amount,
                altSpendPubKey,
                spendAddress,
    ...
    sendBrc20Estimate({ feeRate, altSpendPubKey, spendAddress, spendPubKey, altSpendAddress, testnet, }) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._call('/send-brc20-estimate', 'post', {
                spendPubKey,
                feeRate,
                altSpendPubKey,
                spendAddress,
    ...
    sendCollectibleEstimate({ spendAddress, altSpendAddress, feeRate, testnet, }) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._call('/send-collectible-estimate', 'post', {
                spendAddress,
                altSpendAddress,
                feeRate,
                testnet,
