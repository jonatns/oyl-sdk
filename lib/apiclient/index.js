...
class OylApiClient {
     ...
     * @param limit - The limit of offers to return (Default = 5).
     */
    async getRuneOffers({ ticker, limit = 5, }) {
     ...
     * @param limit - The limit of offers to return (Default = 5).
     */
    async getCollectionOffers({ collectionId, limit = 5, }) {
     ...
     */
    async getOrdinalsWalletNftOfferPsbt({ publicKey, feeRate, address, inscriptions }) {
    ...
    * Get Ordinals-Wallet offer psbt for Collectibles & BRC20s.
    */
    async getOrdinalsWalletRuneOfferPsbt({ publicKey, feeRate, address, outpoints }) {
     ...
     */
    async submitOrdinalsWalletBid({ psbt }) {
