...
class OylApiClient {
    ...
    _call(path, method, data = null) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, node_fetch_1.default)(`${this.host + path}`, {
                method: method,
                body: data,
    ...
    getTickerOffers({ _ticker }) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._call("/get-token-offers", "post", { ticker: _ticker });
        });
    }
    initSwapBid({ address, auctionId, bidPrice, pubKey }) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._call("/get-token-offers", "post", { address, auctionId, bidPrice, pubKey });
        });
    }
    submitBid({ psbtBid, auctionId, bidId }) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._call("/finalize-bid", "post", { psbtBid, auctionId, bidId });
        });
    }
    getFees() {
        return __awaiter(this, void 0, void 0, function* () {
