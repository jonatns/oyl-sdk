...
class OylApiClient {
    ...
    pushTx({ transactionHex }) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._call('/broadcast-transaction', 'post', { transactionHex });
        });
    }
    /**
    ...
    */
    ...
    getCollectiblesById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._call('/get-inscription-info', 'post', { inscription_id: id });
        });
    }
    /**
    ...
    getTickerOffers({ _ticker }) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this._call('/get-token-offers', 'post', { ticker: _ticker });
