...
function loadRpc(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const newWallet = yield wallet.getUtxosArtifacts({ address: "bc1pmtkac5u6rx7vkwhcnt0gal5muejwhp8hcrmx2yhvjg8nenu7rp3syw6yp0" });
...
<<<<<<< HEAD
            case 'testnet-send':
                yield testWallet.recoverWallet({
                    ...
                    network: (0, utils_1.getNetwork)('testnet'),
                    activeIndexes: [0],
                    customPath: 'testnet',
                });
