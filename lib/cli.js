...
function inscribeTest(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        psbt.data.inputs.forEach((v, index) => {
            ...
            const isP2TR = addressType === interface_1.AddressType.P2TR;
            const lostInternalPubkey = !v.tapInternalKey;
            if (isNotSigned && isP2TR && lostInternalPubkey) {
                const tapInternalKey = (0, utils_1.assertHex)(Buffer.from(options.taprootPublicKey, 'hex'));
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        switch (command) {
            ...
            case 'test':
                ...
                const resp = yield createOrdPsbtTx();
                return resp;
                break;
            default:
