...
exports.runCLI = exports.inscribe = exports.callBTCRPCEndpoint = exports.RPC_ADDR = exports.createInscriptionScript = exports.MEMPOOL_SPACE_API_V1_URL = exports.swapFlow = exports.callAPI = exports.viewPsbt = exports.testMarketplaceBuy = exports.loadRpc = void 0;
...
const inscribe = ({ ticker, amount, inputAddress, outputAddress, commitTxId, isDry, }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!commitTxId) {
            ...
            utxosGathered = yield (0, utils_1.getUTXOsToCoverAmountWithRemainder)(inputAddress, fees);
...
function inscribeTest(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const { psbtHex: commitTxResponse, utxosGathered } = yield (0, exports.inscribe)({
            ...
            const toSignInputs = yield formatOptionsToSignInputs(commitTxPsbt, false, options.taprootPublicKey, options.feeFromAddress);
            yield options.signer(commitTxPsbt, toSignInputs);
            ...
            const { result: revealTxId } = yield (0, exports.inscribe)({
                ticker: options.token,
                amount: options.amount,
                inputAddress: options.feeFromAddress,
                outputAddress: options.feeFromAddress,
            ...
            console.log('waiting for 10 seconds');
            yield (0, utils_1.delay)(10000);
            console.log(`CREATING PSBT TO SEND ${options.amount} ${options.token} TO ${options.destinationAddress}`);
            ...
            const utxosGatheredForFees = yield (0, utils_1.getUTXOsToCoverAmount)(options.feeFromAddress, fee, [], utxosGathered);
            const amountGathered = (0, utils_1.calculateAmountGathered)(utxosGatheredForFees);
            ...
            const toSignInputsForTransfer = yield formatOptionsToSignInputs(sendTransferPsbt, false, options.taprootPublicKey, options.feeFromAddress);
            console.log({ sendTransferPsbtBase64: sendTransferPsbt.toBase64() });
            console.log({ sendTransferPsbtHex: sendTransferPsbt.toHex() });
            yield options.signer(sendTransferPsbt, toSignInputsForTransfer);
            ...
            if (isDry) {
                const rpcResponse = yield (0, exports.callBTCRPCEndpoint)('testmempoolaccept', [
                ...
                const { result: transferTxnId } = yield (0, exports.callBTCRPCEndpoint)('sendrawtransaction', finalizedTransferSendPsbtHex);
                ...
                function createOrdPsbtTx() {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        const test0 = yield wallet.createOrdPsbtTx({
                            ...
                            toAddress: 'bc1pkvt4pj7jgj02s95n6sn56fhgl7t7cfx5mj4dedsqyzast0whpchs7ujd7y',
                            txFee: 68,
