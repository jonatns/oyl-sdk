...
function loadRpc(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const blockInfo = yield wallet.sandshrewBtcClient.bitcoindRpc.getBlock("000000000000000000030f0cd2974e34ffa8edb8824eec8bba01c008105ca0bb", 1);
...
function inscribeTest(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (ready) {
            ...
            //SIGN THE PSBT
            const completeInscription = yield signInscriptionPsbt(vPsbt, options.feeRate, options.taprootPublicKey, options.signer);
