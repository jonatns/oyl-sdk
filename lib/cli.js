...
function loadRpc(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const wallet = new oylib_1.Oyl(networkOptions);
        try {
            ...
            const newWallet = yield wallet.listCollectibles({ address: "tb1pcu49t9cdneymqvhmvrgaxs5t0lw5vv8gn7yhgshwkge4jjgm8mqq5529zh" });
