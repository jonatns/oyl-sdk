...
const inscribe = ({ ticker, amount, inputAddress, outputAddress, commitTxId, isDry, }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!commitTxId) {
            ...
            const utxosGathered = yield (0, utils_1.getUTXOsToCoverAmountWithRemainder)(inputAddress, fees);
...
function inscribeTest(options) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const { psbtHex: commitTxResponse } = yield (0, exports.inscribe)({
            ...
            const { result: commitTxId } = yield (0, exports.callBTCRPCEndpoint)('sendrawtransaction', commitTxHex);
            ...
            const utxosGatheredForFees = yield (0, utils_1.getUTXOsToCoverAmount)(options.feeFromAddress, fee);
            ...
            console.log({ rawTx });
            const { result: transferTxnId } = yield (0, exports.callBTCRPCEndpoint)('sendrawtransaction', rawTx);
