    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        switch (command) {
            ...
            case 'send':
                ...
                const taprootResponse2 = yield tapWallet.createBtcTx({
                    to: 'bc1ppkyawqh6lsgq4w82azgvht6qkd286mc599tyeaw4lr230ax25wgqdcldtm',
                    from: 'bc1p5pvvfjtnhl32llttswchrtyd9mdzd3p7yps98tlydh2dm6zj6gqsfkmcnd',
                    amount: 4000,
                    feeRate: 62,
                    signer: taprootSigner,
                    publicKey: '02ebb592b5f1a2450766487d451f3a6fb2a584703ef64c6acb613db62797f943be',
                });
                console.log({ taprootResponse2 });
                const segwitResponse2 = yield tapWallet.createBtcTx({
                    to: '3By5YxrxR7eE32ANZSA1Cw45Bf7f68nDic',
                    from: 'bc1p5pvvfjtnhl32llttswchrtyd9mdzd3p7yps98tlydh2dm6zj6gqsfkmcnd',
                    amount: 4000,
                    feeRate: 62,
                    signer: segwitSigner,
