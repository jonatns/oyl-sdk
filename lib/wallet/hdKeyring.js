...
class HdKeyring extends events_1.EventEmitter {
     ...
     */
    deserialize(_opts = { network: (0, utils_1.getNetwork)('mainnet') }) {
        if (this.root) {
    ...
    addAccounts(numberOfAccounts = 1) {
        if (!this.root) {
            this.initFromMnemonic(new bitcore_mnemonic_1.default().toString(), this.network);
        }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            inputs.forEach(({ index, publicKey, sighashTypes }) => {
                ...
                if ((0, bip371_1.isTaprootInput)(input)) {
                    ...
                    if (((_a = input.witnessUtxo) === null || _a === void 0 ? void 0 : _a.script) && !input.tapInternalKey) {
                        input.tapInternalKey = (0, bip371_1.toXOnly)(Buffer.from(publicKey, 'hex'));
                    }
                    const signer = ((_b = input.witnessUtxo) === null || _b === void 0 ? void 0 : _b.script) &&
