...
exports.truncateString = exports.HdKeyring = void 0;
...
class HdKeyring extends events_1.EventEmitter {
    ...
    _getPrivateKeyFor(publicKey) {
        ...
        console.log({ publicKey: `provided: ${truncateString(publicKey, 12)}` });
    ...
    _getWalletForAccount(publicKey) {
        console.log(truncateString(publicKey, 12), truncateString(this.wallets[0].publicKey.toString('hex'), 12));
