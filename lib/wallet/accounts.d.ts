...
export declare function createWallet(hdPathString: string, type: AddressType, network: bitcoin.Network): {};
...
export declare function importMnemonic(mnemonic: string, path: string, type: AddressType, network: bitcoin.Network): Promise<{}>;
