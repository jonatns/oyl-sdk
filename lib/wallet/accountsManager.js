...
class AccountManager {
     ...
     */
    constructor(options) {
        this.mnemonic = (options === null || options === void 0 ? void 0 : options.mnemonic) || new bitcore_mnemonic_1.default(bitcore_mnemonic_1.default.Words.ENGLISH).toString();
    ...
    initializeAccounts() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            taprootAddresses.push((0, accounts_1.publicKeyToAddress)(taprootAcccounts[0], interface_1.AddressType.P2TR, this.network));
    ...
    recoverAccounts() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (i < taprootAcccounts.length) {
                taprootAddresses.push((0, accounts_1.publicKeyToAddress)(taprootAcccounts[i], interface_1.AddressType.P2TR, this.network));
