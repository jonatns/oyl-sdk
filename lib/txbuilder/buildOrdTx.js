...
const getUtxosForFees = ({ payFeesWithSegwit, psbtTx, feeRate, taprootUtxos, taprootAddress, segwitUtxos, segwitAddress, segwitPubKey, utxosToSend, network, }) => __awaiter(void 0, void 0, void 0, function* () {
=======
const getUtxosForFees = ({ payFeesWithSegwit, psbtTx, feeRate, taprootUtxos, taprootAddress, segwitUtxos, segwitAddress, segwitPubKey, utxosToSend, network }) => __awaiter(void 0, void 0, void 0, function* () {
>>>>>>> 958ea77875e18e293ae1867744d333033a8d7f49
    try {
...
const addSegwitFeeUtxo = ({ segwitUtxos, feeRate, psbtTx, segwitAddress, segwitPubKey, utxosToSend, taprootUtxos, taprootAddress, network }) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const fee = network === (0, utils_1.getNetwork)('testnet') ? 100 : vB * feeRate;
        ...
        for (let i = 0; i < feeUtxos.selectedUtxos.length; i++) {
            if (usableUtxo(feeUtxos.selectedUtxos[i], utxosToSend)) {
                if (addressType === 3) {
                    psbtTx.addInput({
        ...
        psbtTx.addOutput({
            ...
            value: Math.floor(feeUtxos.change - fee),
        });
    }
    catch (e) {
        console.error(e);
