...
const addSegwitFeeUtxo = ({ segwitUtxos, feeRate, psbtTx, segwitAddress, segwitPubKey, utxosToSend, taprootUtxos, taprootAddress, inscription, network, }) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const fee = network === (0, utils_1.getNetwork)('testnet') ? vB * feeRate : vB * feeRate;
