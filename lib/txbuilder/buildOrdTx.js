...
exports.findUtxosForFees = exports.addInscriptionUtxo = exports.getUtxosForFees = exports.buildOrdTx = void 0;
...
const getUtxosForFees = ({ payFeesWithSegwit, psbtTx, feeRate, taprootUtxos, taprootAddress, segwitUtxos, segwitAddress, segwitPubKey, utxoToSend, }) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const addSegwitFeeUtxo = ({ segwitUtxos, feeRate, psbtTx, segwitAddress, segwitPubKey, utxoToSend, }) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const usableUtxo = (feeUtxo) => __awaiter(void 0, void 0, void 0, function* () {
            for (let j = 0; j < utxoToSend.length; j++) {
                if (feeUtxo.txId === utxoToSend[j].txId)
                    return false;
            }
        });
        for (let i = 0; i < feeUtxos.selectedUtxos.length; i++) {
            if (yield usableUtxo(feeUtxos.selectedUtxos[i])) {
                psbtTx.addInput({
...
const addTaprootFeeUtxo = ({ taprootUtxos, feeRate, psbtTx, taprootAddress, utxoToSend, }) => __awaiter(void 0, void 0, void 0, function* () {
