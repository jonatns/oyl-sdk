...
const getUtxosForFees = ({ payFeesWithSegwit, psbtTx, feeRate, taprootUtxos, taprootAddress, inscription, segwitUtxos, segwitAddress, segwitPubKey, utxosToSend, network, fromAddress, }) => __awaiter(void 0, void 0, void 0, function* () {
...
const addSegwitFeeUtxo = ({ segwitUtxos, feeRate, psbtTx, segwitAddress, segwitPubKey, utxosToSend, taprootUtxos, taprootAddress, inscription, network, payFeesWithSegwit, fromAddress, }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (utxosToSend) {
        ...
        for (let i = 0; i < feeUtxos.selectedUtxos.length; i++) {
            if ((0, exports.usableUtxo)(feeUtxos.selectedUtxos[i], utxosToSend === null || utxosToSend === void 0 ? void 0 : utxosToSend.selectedUtxos) &&
