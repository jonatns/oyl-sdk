...
class PSBTTransaction {
     ...
     */
    constructor(signer, address, publicKey, feeRate, network, segwitSigner, segwitPubKey) {
        this.inputs = [];
        this.outputs = [];
        ...
        this.formatOptionsToSignInputs = (psbt) => __awaiter(this, void 0, void 0, function* () {
            ...
            psbt.data.inputs.forEach((v, index) => {
                ...
                if (!isSigned && lostInternalPubkey) {
                    ...
                    const scriptPubkeyHash = (_a = v.witnessUtxo) === null || _a === void 0 ? void 0 : _a.script.toString('hex');
                    const isSameTapScript = scriptPubkeyHash == ((_b = p2tr.output) === null || _b === void 0 ? void 0 : _b.toString('hex'));
                    const isSameSegwitScript = scriptPubkeyHash == ((_c = p2sh.output) === null || _c === void 0 ? void 0 : _c.toString('hex'));
                    if (isSameTapScript) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (segwitInputs.length > 0) {
                    yield this.segwitSigner(psbt, segwitInputs);
                }
