        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.inputs.forEach((v, index) => {
                if (v.utxo.addressType === interface_1.AddressType.P2PKH ||
                    v.utxo.addressType === interface_1.AddressType.P2SH_P2WPKH) {
                    //@ts-ignore
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            psbt.data.inputs.forEach((v, index) => {
                ...
                if (isNotSigned && isP2WPKH) {
                    const segwitInternalKey = (0, utils_1.assertHex)(Buffer.from(this.segwitPubKey, 'hex'));
