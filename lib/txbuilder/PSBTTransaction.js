...
class PSBTTransaction {
      ...
      __awaiter(this, void 0, void 0, function* () {
        ...
        psbt.data.inputs.forEach((v, index) => {
          ...
          if (!isSigned && lostInternalPubkey) {
            const tapInternalKey = (0, utils_1.assertHex)(
            ...
            const isSameScript =
              ((_a = v.witnessUtxo) === null || _a === void 0
                ? void 0
                : _a.script.toString('hex')) ==
              ((_b = p2tr.output) === null || _b === void 0
                ? void 0
                : _b.toString('hex'))
            if (isSameScript) {
              console.log('ADDING TAP INTERNAL KEY!')
  ...
  addInput(utxo, isSegwit = false) {
    if (isSegwit) {
      this.inputs.push(
        (0, utils_1.utxoToInput)(utxo, Buffer.from(this.segwitPubKey, 'hex'))
      )
      return
    }
    this.inputs.push(
      (0, utils_1.utxoToInput)(utxo, Buffer.from(this.pubkey, 'hex'))
    )
  }
  getNumberOfInputs() {
  ...
  signPsbt(psbt) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        console.log('SIGNING PSBT (signPsbt)', psbt)
        const { psbt: formattedPsbt, toSignInputs } =
          yield this.formatOptionsToSignInputs(psbt)
        yield this.signInputs(formattedPsbt, toSignInputs)
        console.log('FORMATTED INPUTS', formattedPsbt)
