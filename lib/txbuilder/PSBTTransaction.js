        ...
        this.formatOptionsToSignInputs = (psbt) => __awaiter(this, void 0, void 0, function* () {
            ...
            psbt.data.inputs.forEach((v, index) => {
                ...
                if (!isSigned && lostInternalPubkey) {
                    ...
                    const isSameTapScript = ((_a = v.witnessUtxo) === null || _a === void 0 ? void 0 : _a.script.toString('hex')) == ((_b = p2tr.output) === null || _b === void 0 ? void 0 : _b.toString('hex'));
                    const isSameSegwitScript = v.witnessUtxo.script.toString('hex') == ((_c = p2sh.output) === null || _c === void 0 ? void 0 : _c.toString('hex'));
                    if (isSameTapScript) {
