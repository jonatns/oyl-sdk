...
class PSBTTransaction {
    ...
    constructor(signer, address, publicKey, feeRate, segwitSigner, segwitPubKey) {
         ...
         */
        this.formatOptionsToSignInputs = (_psbt) => __awaiter(this, void 0, void 0, function* () {
            let toSignInputs = [];
     ...
     */
    signPsbt(psbt, autoFinalized = true) {
        return __awaiter(this, void 0, void 0, function* () {
            const toSignInputs = yield this.formatOptionsToSignInputs(psbt);
            yield this.signInputs(psbt, toSignInputs);
            if (autoFinalized) {
