...
class Provider {
    ...
    api;
    network;
    constructor({ url, projectId, network, networkType, version = 'v1', apiUrl, }) {
        let isTestnet;
        let isRegtest;
        switch (network) {
        ...
        this.opi = new opi_1.OpiRpc(isTestnet);
        this.api = new apiclient_1.OylApiClient({
            network: networkType,
            host: apiUrl ? apiUrl : constants_1.defaultNetworkOptions[networkType].apiUrl,
