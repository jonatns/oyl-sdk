...
exports.splitAlkaneUtxos = exports.createNewPool = exports.createNewPoolPsbt = exports.getPoolId = exports.AlkanesAMMPoolFactoryDecoder = exports.parseAlkaneIdFromHex = exports.PoolFactoryOpcodes = void 0;
    ...
    async decodeAllPoolsDetails(factoryExecution, provider) {
        ...
        for (const poolId of allPools.pools) {
            const request = {
                ...
                txindex: 0,
                target: poolId,
                inputs: [pool_1.PoolOpcodes.POOL_DETAILS.toString()],
                pointer: 0,
                refundPointer: 0,
                vout: 0
            };
...
const createNewPool = async ({ calldata, token0, token0Amount, token1, token1Amount, gatheredUtxos, feeRate, account, signer, provider, }) => {
    const { psbt } = await (0, exports.createNewPoolPsbt)({ calldata, token0, token0Amount, token1, token1Amount, gatheredUtxos, feeRate, account, provider });
