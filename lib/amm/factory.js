...
const __1 = require("..");
const index_1 = require("btc/index");
        ...
        return [
            {
                ...
                output: (0, u32_1.u32)(tokens.length + 4),
            },
            {
                id: new protoruneruneid_1.ProtoruneRuneId((0, u128_1.u128)(BigInt(token.alkaneId.block)), (0, u128_1.u128)(BigInt(token.alkaneId.tx))),
                amount: (0, u128_1.u128)(tokenUtxos.alkaneUtxos
                    .filter((utxo) => utxo.id.block === token.alkaneId.block &&
...
const poolPsbt = async ({ alkaneUtxos, gatheredUtxos, account, protostone, totalTokens, provider, feeRate, fee = 0, }) => {
    try {
        const originalGatheredUtxos = gatheredUtxos;
        const minTxSize = (0, index_1.minimumFee)({
            taprootInputCount: 2,
        ...
        if (fee === 0 && gatheredUtxos.utxos.length > 1) {
            const txSize = (0, index_1.minimumFee)({
