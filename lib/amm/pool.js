...
exports.getPoolId = exports.swap = exports.burn = exports.mint = void 0;
...
const mint = async (calldata, token0, token0Amount, token1, token1Amount, gatheredUtxos, feeRate, account, signer, provider) => {
    ...
    const edicts = [
        {
            ...
            amount: (0, integer_1.u128)(tokenUtxos.totalSentToken0 - Number(token0Amount)),
        ...
        },
        {
            ...
            amount: (0, integer_1.u128)(tokenUtxos.totalSentToken1 - Number(token1Amount)),
            output: (0, integer_1.u32)(1),
        },
        {
            id: new protoruneruneid_1.ProtoruneRuneId((0, integer_1.u128)(BigInt(token1.block)), (0, integer_1.u128)(BigInt(token1.tx))),
            amount: (0, integer_1.u128)(token1Amount),
            output: (0, integer_1.u32)(2),
        },
    ];
    ...
    return await index_1.alkanes.execute({
